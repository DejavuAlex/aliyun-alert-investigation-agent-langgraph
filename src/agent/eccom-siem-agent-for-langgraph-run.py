...
# async def build_eccom_siem_agent():
    # return create_react_agent(
    #         llm,
    #         tools= await eccom_SIEM_agent(),
    #         prompt="""
...
def build_eccom_siem_agent():
    tools = asyncio.run(eccom_SIEM_agent())
    agent = create_agent(
        checkpointer=None,
        model=llm,
        tools=tools,
...
eccom_siem_agent_graph = build_eccom_siem_agent()